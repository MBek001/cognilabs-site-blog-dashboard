        ...
        <div className="overflow-hidden rounded-xl border bg-white">
          <table className="w-full border-collapse text-left text-sm">
            <thead className="bg-zinc-100">
              <tr>
                <th className="border-b px-4 py-3 font-medium">Metric</th>
                <th className="border-b px-4 py-3 font-medium">Value</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border-b px-4 py-3">Active Users (7 days)</td>
                <td className="border-b px-4 py-3">{analytics?.activeUsers ?? 0}</td>
              </tr>
              <tr>
                <td className="border-b px-4 py-3">Screen/Page Views (7 days)</td>
